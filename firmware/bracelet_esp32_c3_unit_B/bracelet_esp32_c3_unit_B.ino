/*
  ...
  ====================================================================================
  HOW IT WORKS:
  - Unit B connects to phone app over BLE
  - When YOU touch Unit B -> sends "TOUCH" to app -> app relays to Unit A
  - When OTHER person touches Unit A -> app relays "TOUCH" to Unit B -> vibrates + LED
  ====================================================================================
*/
...
void idlePulse() {
  // Soft slow purple pulse (different from Unit A blue so you can tell them apart)
...
void incomingTouch() {
  // Vibrate in heartbeat pattern + warm pink/magenta LED
  for (int p = 0; p < 2; p++) {
