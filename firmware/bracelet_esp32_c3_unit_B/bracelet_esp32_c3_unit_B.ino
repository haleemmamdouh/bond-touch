/*
  ====================================================================================
  BOND TOUCH — ESP32-C3 SUPERMINI (UNIT B - DIRECT SEQUENCE & RGB DRIVER)
  ====================================================================================
  EXACT PIN WIRING:
...
#define DEVICE_BLE_NAME        "BondTouch_ESP32_B"
...
void processIncomingCommand(String input) {
  ...
  else if (input == "TOUCH" || input == "V" || input == "B") playHeartbeat();
...
void setup() {
  ...
  Serial.println("BOND TOUCH UNIT B BOOT");
  playBootChime();
  ...
  Serial.println("BOND TOUCH UNIT B READY");
}
